...
SOAP_FMAC3 struct ns__hello * SOAP_FMAC4 soap_new_ns__hello(struct soap *soap, int n);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__hello(struct soap*, const struct ns__hello *, const char*, const char*);

#ifndef soap_write_ns__hello
#define soap_write_ns__hello(soap, data) ( soap_free_temp(soap), soap_begin_send(soap) || (soap_serialize_ns__hello(soap, data), 0) || soap_put_ns__hello(soap, data, "ns:hello", "") || soap_end_send(soap), (soap)->error )
#endif


#ifndef soap_PUT_ns__hello
#define soap_PUT_ns__hello(soap, URL, data) ( soap_free_temp(soap), soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_ns__hello(soap, data), 0) || soap_put_ns__hello(soap, data, "ns:hello", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_PATCH_ns__hello
#define soap_PATCH_ns__hello(soap, URL, data) ( soap_free_temp(soap), soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_ns__hello(soap, data), 0) || soap_put_ns__hello(soap, data, "ns:hello", "") || soap_end_send(soap) || soap_recv_empty_response(soap), soap_closesock(soap) )
#endif


#ifndef soap_POST_send_ns__hello
#define soap_POST_send_ns__hello(soap, URL, data) ( soap_free_temp(soap), ( soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (soap_serialize_ns__hello(soap, data), 0) || soap_put_ns__hello(soap, data, "ns:hello", "") || soap_end_send(soap) ) && soap_closesock(soap), (soap)->error )
#endif

SOAP_FMAC3 struct ns__hello * SOAP_FMAC4 soap_get_ns__hello(struct soap*, struct ns__hello *, const char*, const char*);

#ifndef soap_read_ns__hello
#define soap_read_ns__hello(soap, data) ( ((data) ? (soap_default_ns__hello(soap, (data)), 0) : 0) || soap_begin_recv(soap) || !soap_get_ns__hello(soap, (data), NULL, NULL) || soap_end_recv(soap), (soap)->error )
#endif


#ifndef soap_GET_ns__hello
#define soap_GET_ns__hello(soap, URL, data) ( soap_GET(soap, URL, NULL) || soap_read_ns__hello(soap, (data)), soap_closesock(soap) )
#endif


#ifndef soap_POST_recv_ns__hello
#define soap_POST_recv_ns__hello(soap, data) ( soap_read_ns__hello(soap, (data)) || soap_closesock(soap), (soap)->error )
#endif
